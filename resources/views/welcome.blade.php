...
<body class="bg-light">
    ...
    <script>
        ...
        async function cargarUrls() {
            ...
            const lista = document.getElementById("urlList");
            ...
            urls.forEach((url, index) => {
                ...
                li.innerHTML = `
                    <div>
                        <a href="${url.short_url}" target="_blank">${url.short_url}</a> - </strong>
                        ${estadoBadge}
                    </div>
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu${index}" data-bs-toggle="dropdown" aria-expanded="false">
                            Acciones
                        </button>
